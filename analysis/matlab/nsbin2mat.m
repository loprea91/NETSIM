function [params, si, st, v, lz, ge, gi] = nsbin2mat(paramfile, outputdir, jobid)
...
[si, st] = load_netsim_spikes(fullfile(outputdir, sprintf('%08dspk_times.bin', jobid ) ) ,  ...
    fullfile(outputdir, sprintf('%08dspk_ids.bin', jobid ) ) );
...
it = 0.2;
[params,v,ge,gi,lz,st,si] = nsrminit(it,params,v,ge,gi,lz,st,si);
